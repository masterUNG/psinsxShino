                  ...
                  children: [
                    ...
                    displayIconTakePhoto
                        ? WidgetIconButton(
                            ...
                            pressFunc: () async {
                              MyDialog(context: context).normalDialot(
                                  title: 'Confirm TakePhoto',
                                  subTitle: 'Please Confirm Take Photo',
                                  firstButton: WidgetTextButton(
                                    label: 'Confirm Take Photo',
                                    pressFunc: () async {
                                      print(
                                          '##29jan press TakePhoto --> ${dmsxModels[indexDirection].toJson()}');
                                      var result =
                                      ...
                                      if (result != null) {
                                        ...
                                        String nameFile =
                                            '${dmsxModels[indexDirection].id}${dmsxModels[indexDirection].ca}.jpg';
    ...
    await Dio().get(urlAPI).then((value) {
      if (value.toString() == 'null') {
        ...
        for (var element in json.decode(value.data)) {
          ...
          print('##29jan dmsxBeforImageModel ---> ${model.toMap()}');
